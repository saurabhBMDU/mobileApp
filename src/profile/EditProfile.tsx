...
const EditProfile = () => {
    ...
    if (isConnected == false) {
        ...
        return (
            <ScrollView style={{ backgroundColor: 'white', paddingBottom: hp(5) }} showsVerticalScrollIndicator={false}>
                ...
                <ScrollView style={{ width: wp(95), alignSelf: 'center' }} showsVerticalScrollIndicator={false}>
                    <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                        <TouchableOpacity onPress={() => handleDocumentPicker()}>
                            <Image source={handleRenderProfilePhoto()} style={{ height: wp(25), width: wp(25), resizeMode: "center", borderRadius: wp(40), marginTop: hp(1.5) }} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ marginTop: hp(1.5), width: wp(95) }}>
                        <View style={{ width: wp(95), }}>
                            <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>Name</Text>
                            <TextInput onChangeText={(e) => setName(e)} value={name} placeholder={isLoading ? 'Loading...' : 'Enter Your Name'} placeholderTextColor={'gray'}
                        ...
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            ...
                            <View
                                style={{ width: wp(95), }} >
                                <TextInput value={email} editable={false} placeholder={isLoading ? 'Loading...' : 'Enter Your Phone Email'} placeholderTextColor={'gray'} style={[styles.inputfildeStyle, { backgroundColor: "#eee" }]} />
                            </View>
                        </View>
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>Phone Number</Text>
                            <TextInput onChangeText={(e) => setMobile(e)} value={mobile} placeholder={isLoading ? 'Loading...' : 'Enter Your Phone Number'} placeholderTextColor={'gray'}
                                style={styles.inputfildeStyle} />
                        </View>
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>Address</Text>
                            <TextInput onChangeText={(e) => setAddress(e)} value={address} placeholder={isLoading ? 'Loading...' : 'Enter Your Address'} placeholderTextColor={'gray'}
                                style={styles.inputfildeStyle} />
                        </View>
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>State</Text>
                            <TextInput onChangeText={(e) => setState(e)} value={state} placeholder={isLoading ? 'Loading...' : 'Enter Your state'} placeholderTextColor={'gray'}
                                style={styles.inputfildeStyle} />
                        </View>
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>Country</Text>
                            <TextInput value={"India"} placeholder={isLoading ? 'Loading...' : 'Enter Your Address'} placeholderTextColor={'gray'}
                                style={styles.inputfildeStyle} />
                        </View>
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>Pincode</Text>
                            <TextInput onChangeText={(e) => setPinCode(e)} value={`${pinCode}`} keyboardType='number-pad' maxLength={6} placeholder={isLoading ? 'Loading...' : 'Enter Your Pincode'} placeholderTextColor={'gray'}
                                style={styles.inputfildeStyle} />
                        </View>

                        {
                            ...
                            <View style={{ width: wp(95), marginTop: hp(2) }}>
                                ...
                                <TextInput editable={false} onChangeText={(e) => setSpecialization(e)} value={specialization} placeholder={isLoading ? 'Loading...' : 'Your specialization'} placeholderTextColor={'gray'}
                                    style={styles.inputfildeStyle} />
                            </View>
                        }

                        {
                            ...
                            <View style={{ width: wp(95), marginTop: hp(2) }}>
                                ...
                                <TextInput onChangeText={(e) => setAbhaid(e)} value={abhaid} placeholder={isLoading ? 'Loading...' : 'Your Abha Id'} placeholderTextColor={'gray'}
                                    style={styles.inputfildeStyle} />
                            </View>
                        }
