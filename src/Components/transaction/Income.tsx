...
const Income = () => {
    ...
    console.log("thinkjbhkhjlkghdlkjfsndlkjgsdlkjgflkjnl", incomeTrans);
        ...
        <View>
            ...
            <FlatList
                    ...
                    <>
                        {loading ? (
                            ...
                            <View style={{ height: hp(70), justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ fontSize: hp(2) }}>No income transactions found</Text>
                            </View>
                        )}
                    </>
                }
                ...
                renderItem={({ item, index }: any) => {
                    ...
                    return (
                        <View style={{ width: width, paddingTop: hp(0.75), paddingBottom: hp(2), backgroundColor: item.type == 'debit' ? '#F3ECEF' : '#E9F5F3', elevation: 3, marginBottom: hp(1) }}>
