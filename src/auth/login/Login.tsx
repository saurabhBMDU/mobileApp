...
const Login = () => {
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', }}>
            ...
            resizeMode='contain' 
            style={{ width: wp(70), height: hp(20), marginTop: hp(10),  alignItems: 'center',justifyContent: 'center', }} 
...
<View style={{ backgroundColor: '#eee', flex:1, width: width, justifyContent: 'center', alignItems: 'center',marginBottom:50 }}>
    <Text style={[styles.login_Text, { fontFamily: mainFont, color: '#1263AC',fontWeight:"bold", }]}>Login</Text>
    <View style={{ width: wp(90), alignSelf: 'center', marginTop: hp(2) }}>

        {/* Email section >>>>>>>>>>>>>>>>>>>>>*/}
        <Text style={{ color: '#1263AC',fontWeight:'bold' }}>Mobile Number/Email</Text>
        ...
        {/* <View style={{ marginTop: hp(4), flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}> */}
            ...
            <Text style={{ fontSize: hp(2), fontWeight: '600', color: '#1263AC', fontFamily: 'AvenirNextLTPro-Regular',alignSelf:"center",padding:10,}}>Or</Text>
            {/* <View style={styles.Both_small_Line}></View> */}
        {/* </View> */}
        ...
        <TouchableOpacity
            ...
            style={[styles.both_reg_continew_BTN, { borderColor: '#fff',backgroundColor:'#1263AC' }]}>
