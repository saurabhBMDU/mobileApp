          ...
          <View style={styles.sunView}>
            ...
            <ScrollView
              ...
              {images ? null : (
                <View>
                  <View style={styles.d_flex2}>
                    <Text style={[styles.textStle, {width: '37%'}]}>
                      Symptoms:
                    </Text>
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.symptoms
                        ? objectData.symptoms
                        : ''}
                    </Text>
                  </View>
                  <View style={styles.d_flex2}>
                    ...
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.diagnosis
                        ? objectData.diagnosis
                        : ''}
                    </Text>
                  </View>
                  <View style={styles.d_flex2}>
                    ...
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.drugAllergy
                        ? objectData.drugAllergy
                        : ''}
                    </Text>
                  </View>
                  <View style={styles.d_flex2}>
                    ...
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.pastHistory
                        ? objectData.pastHistory
                        : ''}
                    </Text>
                  </View>
                  <View style={styles.d_flex2}>
                    ...
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.personalHistory
                        ? objectData.personalHistory
                        : ''}
                    </Text>
                  </View>
                  <View style={styles.d_flex2}>
                    ...
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.surgicalHistory
                        ? objectData.surgicalHistory
                        : ''}
                    </Text>
                  </View>
                  ...
                  <View style={styles.d_flex2}>
                    ...
                    <Text style={[styles.textStle, {fontFamily: mainFont}]}>
                      {objectData && objectData.investigation
                        ? objectData.investigation
                        : ''}
                    </Text>
                  </View>
                  ...
                  <View>
                    {objectData &&
                      objectData.medicine &&
                      objectData.medicine.length > 0 &&
                      objectData.medicine[0].name &&
                      objectData.medicine.map((itms, index) => {
                        return (
                          <>
                            <Text
                              style={{
                            ...
                            <View style={styles.mainViewMap}>
                              ...
                              <View style={styles.d_flex2}>
                                ...
                                <Text
                                  ...
                                  {itms.duration_count} {itms.duration}
                                </Text>
                              </View>
                            </View>
                          </>
              ...
              <View style={[styles.dflex, {marginTop: hp(5)}]}>
                <TouchableOpacity
                  style={[styles.bothBtn, {backgroundColor: '#000'}]}
                  onPress={() => clodeBtn()}>
